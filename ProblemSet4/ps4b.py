...
def playGame(wordList):
    ...
    while True:
        user_input = ''
        while not(user_input == 'n' or user_input == 'r' and bool(hand) or user_input == 'e'):
            user_input = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
            if user_input == 'r' and not bool(hand):
                print("You have not played a hand yet. Please play a new hand first!")  
            if not(user_input == 'n' or user_input == 'r' or user_input == 'e'):
        ...
        while not(user_input2 == 'u' or user_input2 == 'c'):
            ...
            if not(user_input2 == 'u' or user_input2 == 'c'):
                print("Invalid command.")  
        if user_input == 'n':
